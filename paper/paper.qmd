...
The dataset only records data from February 28th, 2024 to November 11th, 2024. The problem is then that the February entry in @fig-month does not accurately reflect the average grocery discount. For future study, I'd want to have a greater variation of our data across multiple years so we can find a more accurate the average grocery discount for each month. 
